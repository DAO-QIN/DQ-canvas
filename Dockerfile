...
FROM node:26-bookworm-slim@sha256:cd565714d4da3e84bfd341e31448f81d47c6362198f152345297c9c1154e6341 AS web-build

WORKDIR /app/web
ARG BUILD_NODE_OPTIONS=--max-old-space-size=1536
ARG NEXT_BUILD_CPUS=1
ARG NEXT_PUBLIC_DQ_CREATIVE_WORKSPACE_CANVAS_ENABLED=0
ARG NEXT_PUBLIC_DQ_CREATIVE_WORKSPACE_DESIGN_ENABLED=0
...
ENV NEXT_PUBLIC_DQ_CREATIVE_WORKSPACE_CANVAS_ENABLED=${NEXT_PUBLIC_DQ_CREATIVE_WORKSPACE_CANVAS_ENABLED}
ENV NEXT_PUBLIC_DQ_CREATIVE_WORKSPACE_DESIGN_ENABLED=${NEXT_PUBLIC_DQ_CREATIVE_WORKSPACE_DESIGN_ENABLED}
