import { BookMarked, Clapperboard, Compass, FileText, GalleryVerticalEnd, ImagePlus, Images, Maximize2, PanelsTopLeft, Sparkles, UserRound, Video } from "lucide-react";
